...
public class AxonConfiguration {
    ...
    EventSourcingRepository<AccountAggregate> accountEventSourcingRepository() {
        EventSourcingRepository<AccountAggregate> repo = new EventSourcingRepository<AccountAggregate>(AccountAggregate.class, eventStore());
     ...
     */
    @Bean
    AggregateAnnotationCommandHandler<AccountAggregate> productAggregateCommandHandler() {
        @SuppressWarnings("deprecation")
		AggregateAnnotationCommandHandler<AccountAggregate> handler = new AggregateAnnotationCommandHandler<AccountAggregate>(
                AccountAggregate.class,
                accountEventSourcingRepository(),
                commandBus());
        return handler;
    }
